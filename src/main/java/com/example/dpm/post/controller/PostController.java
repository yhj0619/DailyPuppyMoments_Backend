...
//    }
    ...
    public ResponseEntity<PageResponseDto<PostDto>> getAllPostsBySort(@ModelAttribute PageRequestDto pageRequestDto, @PathVariable("sort") String sort) {
    ...
    public ResponseEntity<PageResponseDto<PostDto>> searchPostsByTag(
