...
//    }
//    @PostMapping("/token/refresh")
//    public ResponseEntity<TokenResponseDto> tokenRefresh(HttpServletRequest request) {
//        Cookie[] cookies = request.getCookies();
//        
//        // 쿠키가 없거나 refresh_token이 없는 경우
//        if (cookies == null || Arrays.stream(cookies).noneMatch(cookie -> "refresh_token".equals(cookie.getName()))) {
//            System.out.println("#OauthController : No cookies found or refresh_token not present");
//            throw new CustomException(ErrorCode.INVALID_REFRESH_TOKEN);
//        }
//
...
//                .findFirst()
//                .orElseThrow(() -> {
//                    System.out.println("#OauthController : refresh_token cookie is missing");
//                    return new CustomException(ErrorCode.INVALID_REFRESH_TOKEN);
//                });
//
//        // 리프레시 토큰 값 출력
//        System.out.println("#OauthController : Received refresh_token: " + refreshTokenCookie.getValue());
//
//        // 액세스 토큰 재발급
//        String accessToken = oauthService.refreshAccessToken(refreshTokenCookie.getValue());
//
//        // 재발급된 액세스 토큰 출력
//        System.out.println("#OauthController : New access token issued: " + accessToken);
//
//        TokenResponseDto refreshTokenResponseDto = new TokenResponseDto();
//        refreshTokenResponseDto.setAccessToken(accessToken);
//        
